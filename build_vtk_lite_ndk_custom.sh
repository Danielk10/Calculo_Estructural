...
export CPPFLAGS="-I$HOME/vtk_compat -I$FAKE_USR/include -I$TMX_PREFIX/include"
...
export LDFLAGS="-pie -Wl,-z,max-page-size=16384 -lm -L$FAKE_USR/lib -L$TMX_PREFIX/lib -L/system/lib64 -llog -landroid"
export SHARED_LDFLAGS="-Wl,-z,max-page-size=16384 -lm -L$FAKE_USR/lib -L$TMX_PREFIX/lib -L/system/lib64 -llog -landroid"
