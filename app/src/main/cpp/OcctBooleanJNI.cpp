...
Java_com_diamon_civil_solids_engine_OcctBooleanJNI_fuse(JNIEnv *env, jclass clazz, jstring path_a, jstring path_b, jstring out_path) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_diamon_civil_solids_engine_OcctBooleanJNI_cut(JNIEnv *env, jclass clazz, jstring path_a, jstring path_b, jstring out_path) {
    const char *pa = env->GetStringUTFChars(path_a, nullptr);
    const char *pb = env->GetStringUTFChars(path_b, nullptr);
    const char *po = env->GetStringUTFChars(out_path, nullptr);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_diamon_civil_solids_engine_OcctBooleanJNI_intersect(JNIEnv *env, jclass clazz, jstring path_a, jstring path_b, jstring out_path) {
    const char *pa = env->GetStringUTFChars(path_a, nullptr);
    const char *pb = env->GetStringUTFChars(path_b, nullptr);
    const char *po = env->GetStringUTFChars(out_path, nullptr);
