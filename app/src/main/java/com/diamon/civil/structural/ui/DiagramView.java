...
public class DiagramView extends View {
    ...
    private StructuralBeamDatParser.ParseResult results;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Map<Integer, StructuralBeamDatParser.SectionForces> elemResults = new HashMap<>();
        for (StructuralBeamDatParser.SectionForces sf : results.forces) {
        ...
        for (StructuralModel.Element e : model.elements) {
            ...
            if (results.displacements != null) {
                for (StructuralBeamDatParser.NodeDisplacement nd : results.displacements) {
            ...
            // Draw Diagram
            StructuralBeamDatParser.SectionForces f = elemResults.get(e.id);
            if (f != null) {
                double value = 0;
                double maxVal = 1.0;
