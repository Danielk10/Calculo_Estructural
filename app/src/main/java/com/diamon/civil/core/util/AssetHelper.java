...
/**
 * Improved class for asset and native binary management.
 * Follows Android policies for binary names (lib*.so)
 * and restores original names via symlinks.
 */
public class AssetHelper {
    private static final String TAG = "AssetHelper";
    private static final String PREFS_NAME = "AssetHelperPrefs";
    private static final String KEY_EXTRACTED = "assets_extracted_v5"; // Version incremented due to nomenclature changes
     ...
     * 1. Extracts the 'usr' folder from assets to internal memory.
     * 2. Creates the necessary symlinks for native binaries.
     */
    public synchronized boolean ensureRuntimeReady() {
        ...
        if (!alreadyExtracted) {
            Log.i(TAG, "Extracting assets for the first time or updating...");
    ...
    /**
     * Recursively extracts files from assets.
     */
    ...
    private boolean ensureNativeToolLinks() {
        ...
        ok &= linkTool(new File(usrLib, "libTKDEGLTF.so"), "libTKDEGLTF.so");
        ok &= linkTool(new File(usrLib, "libTKDEGLTF.so."), "libTKDEGLTF.so_dot.so");
        ok &= linkTool(new File(usrLib, "libTKDEGLTF.so.8.0.0"), "libTKDEGLTF_v8_0_0.so");
        ...
        ok &= linkTool(new File(usrLib, "libTKXSDRAWGLTF.so"), "libTKXSDRAWGLTF.so");
        ok &= linkTool(new File(usrLib, "libTKXSDRAWGLTF.so."), "libTKXSDRAWGLTF.so_dot.so");
        ok &= linkTool(new File(usrLib, "libTKXSDRAWGLTF.so.8.0.0"), "libTKXSDRAWGLTF_v8_0_0.so");
        ...
        ok &= linkTool(new File(usrLib, "libgmsh.so"), "libgmsh_v5_0.so");
        ...
        ok &= linkTool(new File(usrLib, "libmedimport.so"), "libmedimport_v0.so");
        ...
        ok &= linkTool(new File(usrLib, "libopenblasp-r0.3.34.dev.so"), "libopenblasp-r0.3.34.dev.so");
        ...
        // --- New libraries from commits 78b78f4 and b90ea65 ---
        ok &= linkTool(new File(usrLib, "libaec.so"), "libaec.so");
        ok &= linkTool(new File(usrLib, "libaec.so.0"), "libaec_v0.so");
        ok &= linkTool(new File(usrLib, "libaec.so.0.1.7"), "libaec_v0_1_7.so");
        ok &= linkTool(new File(usrLib, "libdraco.so"), "libdraco.so");
        ok &= linkTool(new File(usrLib, "libdraco.so.9"), "libdraco_v9.so");
        ok &= linkTool(new File(usrLib, "libdraco.so.9.0.0"), "libdraco_v9_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_cpp.so"), "libhdf5_cpp.so");
        ok &= linkTool(new File(usrLib, "libhdf5_cpp.so.1000"), "libhdf5_cpp_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_cpp.so.1000.0.0"), "libhdf5_cpp_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_f90cstub.so"), "libhdf5_f90cstub.so");
        ok &= linkTool(new File(usrLib, "libhdf5_f90cstub.so.1000"), "libhdf5_f90cstub_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_f90cstub.so.1000.0.0"), "libhdf5_f90cstub_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_fortran.so"), "libhdf5_fortran.so");
        ok &= linkTool(new File(usrLib, "libhdf5_fortran.so.1000"), "libhdf5_fortran_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_fortran.so.1000.0.0"), "libhdf5_fortran_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_cpp.so"), "libhdf5_hl_cpp.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_cpp.so.1000"), "libhdf5_hl_cpp_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_cpp.so.1000.0.0"), "libhdf5_hl_cpp_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_f90cstub.so"), "libhdf5_hl_f90cstub.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_f90cstub.so.1000"), "libhdf5_hl_f90cstub_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_f90cstub.so.1000.0.0"), "libhdf5_hl_f90cstub_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_fortran.so"), "libhdf5_hl_fortran.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_fortran.so.1000"), "libhdf5_hl_fortran_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_hl_fortran.so.1000.0.0"), "libhdf5_hl_fortran_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libhdf5_tools.so"), "libhdf5_tools.so");
        ok &= linkTool(new File(usrLib, "libhdf5_tools.so.1000"), "libhdf5_tools_v1000.so");
        ok &= linkTool(new File(usrLib, "libhdf5_tools.so.1000.0.0"), "libhdf5_tools_v1000_0_0.so");
        ok &= linkTool(new File(usrLib, "libsz.so"), "libsz.so");
        ok &= linkTool(new File(usrLib, "libsz.so.2"), "libsz_v2.so");
        ok &= linkTool(new File(usrLib, "libsz.so.2.0.1"), "libsz_v2_0_1.so");
        ok &= linkTool(new File(usrLib, "libtbb.so"), "libtbb.so");
        ok &= linkTool(new File(usrLib, "libtbb.so.12"), "libtbb_v12.so");
        ok &= linkTool(new File(usrLib, "libtbb.so.12.13"), "libtbb_v12_13.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc.so"), "libtbbmalloc.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc.so.2"), "libtbbmalloc_v2.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc.so.2.13"), "libtbbmalloc_v2_13.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc_proxy.so"), "libtbbmalloc_proxy.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc_proxy.so.2"), "libtbbmalloc_proxy_v2.so");
        ok &= linkTool(new File(usrLib, "libtbbmalloc_proxy.so.2.13"), "libtbbmalloc_proxy_v2_13.so");
        // --- New executables from commit 78b78f4 ---
        ok &= linkTool(new File(usrBin, "draco_decoder"), "libdraco_decoder.so");
        ok &= linkTool(new File(usrBin, "draco_decoder-1.5.7"), "libdraco_decoder_1.5.7.so");
        ok &= linkTool(new File(usrBin, "draco_encoder"), "libdraco_encoder.so");
        ok &= linkTool(new File(usrBin, "draco_encoder-1.5.7"), "libdraco_encoder_1.5.7.so");
        ok &= linkTool(new File(usrBin, "drawenv"), "libdrawenv.so");
        ok &= linkTool(new File(usrBin, "h5clear"), "libh5clear.so");
        ok &= linkTool(new File(usrBin, "h5copy"), "libh5copy.so");
        ok &= linkTool(new File(usrBin, "h5debug"), "libh5debug.so");
        ok &= linkTool(new File(usrBin, "h5delete"), "libh5delete.so");
        ok &= linkTool(new File(usrBin, "h5diff"), "libh5diff.so");
        ok &= linkTool(new File(usrBin, "h5dump"), "libh5dump.so");
        ok &= linkTool(new File(usrBin, "h5format_convert"), "libh5format_convert.so");
        ok &= linkTool(new File(usrBin, "h5import"), "libh5import.so");
        ok &= linkTool(new File(usrBin, "h5jam"), "libh5jam.so");
        ok &= linkTool(new File(usrBin, "h5ls"), "libh5ls.so");
        ok &= linkTool(new File(usrBin, "h5mkgrp"), "libh5mkgrp.so");
        ok &= linkTool(new File(usrBin, "h5perf_serial"), "libh5perf_serial.so");
        ok &= linkTool(new File(usrBin, "h5repack"), "libh5repack.so");
        ok &= linkTool(new File(usrBin, "h5repart"), "libh5repart.so");
        ok &= linkTool(new File(usrBin, "h5stat"), "libh5stat.so");
        ok &= linkTool(new File(usrBin, "h5unjam"), "libh5unjam.so");
        ok &= linkTool(new File(usrBin, "h5watch"), "libh5watch.so");
        ok &= linkTool(new File(usrBin, "h5cc"), "libh5cc.so");
        ok &= linkTool(new File(usrBin, "h5fc"), "libh5fc.so");
    ...
    /**
     * Creates a secure symlink.
     * @param linkPath Path where the symlink will be created (e.g., usr/bin/ccx)
     * @param nativeLibName Name of the real file in jniLibs (e.g., libccx.so)
     */
    private boolean linkTool(File linkPath, String nativeLibName) {
        ...
        if (!target.exists()) {
            Log.e(TAG, "Native library missing in jniLibs: " + nativeLibName);
            return false;
        }
        ...
        try {
            ...
            Log.d(TAG, "Symlink created: " + linkPath.getAbsolutePath() + " -> " + target.getAbsolutePath());
            return true;
        } catch (Exception e) {
            Log.w(TAG, "Symlink failed for " + linkPath.getName() + ", attempting copy fallback: " + e.getMessage());
    ...
    private boolean copyFile(File source, File dest) {
        try (InputStream in = new java.io.FileInputStream(source);
            ...
            out.flush();
            // Ensure execution permissions if it's a binary
            if (dest.getParentFile() != null && dest.getParentFile().getName().equals("bin")) {
                dest.setExecutable(true, true);
            }
            return true;
        } catch (IOException e) {
            Log.e(TAG, "Error in copy fallback: " + e.getMessage());
            return false;
        }
    }
}
