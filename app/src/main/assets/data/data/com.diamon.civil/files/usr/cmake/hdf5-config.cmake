...
if (NOT TARGET "hdf5")
  ...
  if (${HDF5_PACKAGE_NAME}_PROVIDES_SZIP_SUPPORT AND OFF)
    if (OFF)
      set (_libaec_targets_file_name "${PACKAGE_PREFIX_DIR}/cmake/libaec_static-targets.cmake")
    else ()
      set (_libaec_targets_file_name "${PACKAGE_PREFIX_DIR}/cmake/libaec_shared-targets.cmake")
    endif ()
