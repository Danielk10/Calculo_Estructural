...
# Use robust pattern to find the line and wrap it with #ifndef __BIONIC__ / #endif
...
echo "=== Configurando VTK para OCCT (TKIVtk) + Gmsh/CalculiX + SceneView via GLES/EGL ==="
cmake .. \
