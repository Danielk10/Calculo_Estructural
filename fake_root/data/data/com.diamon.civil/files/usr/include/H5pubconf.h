...
#define H5_DEFAULT_PLUGINDIR "/data/data/com.diamon.civil/files/usr/lib/plugin:/usr/local/hdf5/lib/plugin"
...
/* Define if plugin digital signature verification is required */
/* #undef H5_REQUIRE_DIGITAL_SIGNATURE */
