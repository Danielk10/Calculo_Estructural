...
/*En anglais*/
#define MED_MAJOR_NUM  6
#define MED_MINOR_NUM  0
#define MED_RELEASE_NUM 1
  
#define MED_3_LATEST_MINOR    3
#define MED_4_LATEST_MINOR    2
#define MED_40_LATEST_RELEASE 1
#define MED_41_LATEST_RELEASE 2
#define MED_42_LATEST_RELEASE @MED_42_LATEST_RELEASE@
#define MED_5_LATEST_MINOR    1
#define MED_50_LATEST_RELEASE 2
#define MED_51_LATEST_RELEASE 0
#define MED_6_LATEST_MINOR    0
#define MED_60_LATEST_RELEASE 1

/*En franglais*/
#define MED_NUM_MAJEUR  6
...
#define MED_LNAME_BLANK  MED_NAME_BLANK MED_SNAME_BLANK
...
#define med_interlacing_mode med_switch_mode
...
typedef enum {MED_MESH, MED_FIELD, MED_LIBRARY, MED_FILE,
        ...
        MED_LINK, MED_FAMILY_ZERO, MED_FAMILY_NODE, MED_FAMILY_ELEM,
        MED_CLASS_UNDEF=-1, MED_CLASS_ALL=-2 } med_class;
...
#define MED_UNDEF_CONSTITUENT -1              /**<Valeur indéfinie pour electionner les constituants d'une valeur.
                                                 Les constituants d'une valeur peuvent être les composantes
                                                 des coordonnées des noeuds, les noeuds d'une connectivité nodal, 
                                                 les composantes d'un champ. */
...
/** \struct med_path
    \brief  Aggrégation de noms medfichier pour définir un chemin d'accès aux objets med de type class #med_class
*/
#define MED_MAX_NAME_IN_PATH 5
#define MED_MAX_DATAGROUPNAME_IN_PATH 2*MED_MAX_NAME_IN_PATH*MED_NAME_SIZE /**< \2* for max internal intermediate groupname */

typedef struct {
  /*PUBLIC IN attributes*/
  med_class           medclass;
  med_int             nname;                      /**< \MEDfileObjectDescriptionPathRem2 */
  const char *        name[MED_MAX_NAME_IN_PATH]; /**< \MEDfileObjectDescriptionPathRem2 */
  /*PRIVATE attributes*/
  char                _datagroupname[MED_MAX_DATAGROUPNAME_IN_PATH+1]; /** \internal*/
} med_path;
...
typedef enum {MED_FILTER_LIST       = 1,
              MED_FILTER_BLOCK      = 2,
              MED_FILTER_TYPE_UNDEF =-1 } med_filter_type; 
...
typedef struct {
  ...
  /* profil utilisé et mode de stockage en mémoire */
  med_storage_mode storagemode;
  char             profilename[MED_NAME_SIZE+1];
  /* Sélection par block d'entités */
  med_size         start        ;
  med_size         stride       ;
  med_size         count        ;
  med_size         blocksize    ;
...
#define MED_FILTER_INIT { 0, MED_MAX_FILTER_SPACES_INIT, MED_MAX_FILTER_SPACES_INIT,         \
                          MED_FILTER_TYPE_UNDEF, 0, 0, 0, 0,				     \
                          MED_UNDEF_INTERLACE,MED_UNDEF_INTERLACE,MED_NO_FILTER_SIZE,        \
      NULL, NULL, MED_NO_PROFILE_SIZE,MED_UNDEF_PFLMODE,MED_NO_PROFILE,\
                          0, 0, 0, 0, 0 }
...
typedef struct {
  ...
  int     ref_count; /**< Compteur de référence sur le nombre d'utilisations d'une image mémoire */
...
/* TODO : Ajouter un module de documentation pour ces fonctions */
...
extern MEDC_EXPORT const char * const  MEDgetInterlacingModeName(med_interlacing_mode interlacing);
