...
# installed.
TCL_PREFIX='/data/data/com.diamon.civil/files/usr'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data/data/com.diamon.civil/files/usr'
...
TCL_EXTRA_CFLAGS='-fPIC -fPIE -Oz -ffile-prefix-map== -pipe -I/data/data/com.diamon.civil/files/usr/include -I/data/data/com.termux/files/usr/include'
...
TCL_LD_FLAGS='-pie -Wl,-z,max-page-size=16384 -L/data/data/com.diamon.civil/files/usr/lib -L/data/data/com.termux/files/usr/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/data/data/com.diamon.civil/files/usr/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data/data/com.diamon.civil/files/usr/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data/data/com.diamon.civil/files/usr/include'
...
# compiled.
TCL_SRC_DIR='/data/data/com.diamon.civil/files/usr/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/data/data/com.diamon.civil/files/usr/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/data/data/com.diamon.civil/files/usr/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/data/data/com.diamon.civil/files/usr/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/data/data/com.diamon.civil/files/usr/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/data/data/com.diamon.civil/files/usr/lib/libtclstub8.6.a'
