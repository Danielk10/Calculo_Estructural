...
| `android.permission.FOREGROUND_SERVICE`<br>`android.permission.FOREGROUND_SERVICE_DATA_SYNC`<br>`android.permission.FOREGROUND_SERVICE_SPECIAL_USE` | API 24 – API 37 | **Continuidad de Procesos en Primer Plano:** Asegura que los procesos de cálculo de ingeniería de alta exigencia computacional no sean terminados por el gestor de memoria o el sistema de optimización de tareas en segundo plano en versiones recientes de Android (Android 14+ / API 34 a API 37). |
